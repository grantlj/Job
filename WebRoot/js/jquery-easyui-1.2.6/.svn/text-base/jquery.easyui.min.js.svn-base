...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showRefresh:true,onSelectPage:function(_76,_77){
...
//为解决window的拖动范围限制 。注释人：汪小银；修改时间：2013-10-11
function _1dc(_1dd){
...
win.window({title:_206,noheader:(_206?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,shadow:false,draggable:true,resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
win.window({title:opts.title,width:opts.width,height:opts.height,collapsible:false,minimizable:false,maximizable:false,shadow:false,draggable:true,resizable:false,closed:true,onBeforeOpen:function(){
...
//为设置tab上超出范围后使"左边的滚动按钮"不显示。修改人：汪小银；修改时间：2013-08-28
if(_25a>_25b){
//_258.show();
_259.show();
...
wrap.css({marginLeft:0,marginRight:_259.outerWidth()+tool.outerWidth(),left:0,width:_25b-_259.outerWidth()});
}else{
_258.hide();
_259.hide();
tool.css("right",0);
...
//解决1.2.6版本中的不支持复合验证功能 。注释人：汪小银；注释时间：2013-10-08
function _3b7(_3b8){
var _35b=/([a-zA-Z_]+)(.*)/.exec(_3b8);
...
},message:"Please enter a valid URL."},lengt:{validator:function(_364,_365){
...
if(box.length){
//解决表单提交时重复触发失去焦点事件 。注释人：郭洪年；注释时间：2013-10-11
...
_69b.appendTo("body");
var inputWidth = opts.width; // 缓存自己设置的宽度值
if(isNaN(opts.width)){
opts.width=_69b.find("input.combo-text").width();
}
var _69d=0;
if(opts.hasDownArrow){
_69d=_69b.find(".combo-arrow").width();
}
...
/*
 * IE6下重新设置宽度IE6下重新设置宽度
 * @author pj
 */
if($.browser.version == "6.0") {
	_69b.find("input.combo-text").width(inputWidth - 18);
	_69c.panel("resize",{width:(opts.panelWidth?opts.panelWidth:inputWidth+2),height:opts.panelHeight});
}
...
_6b4(_6a8);
break;
//加了backspace 8和delete 48的删除事件 修改人：汪小银 修改时间：2013.11.20
case 46:
_6be(_6a8);
break;
case 8:
